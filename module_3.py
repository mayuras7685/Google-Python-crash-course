...
"""
2.
The show_letters function should print out each letter of a word on 
...
Tip: you can figure out the digits of a number by dividing it by 10 once per 
...
of its column). Fill in the blanks so that calling multiplication_table(1, 3) will print out:
1 2 3 
